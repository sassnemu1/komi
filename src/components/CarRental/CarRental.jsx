...
// ─── Контент блоков ───────────────────────────────────────────────
// Факты — из README холдинга «Велес И К», README коридора
// Якша—Маньпупунёр и сайта YÖRAN (yoran-web.vercel.app): Taigarenda —
// сервис проката холдинга, часть цифровой экосистемы komi.world; зимняя
// программа фуникулёра «Якша Skyview» планируется на снегоходах YÖRAN,
// снегоход линейки — «Йиркап» (III ступень, план 2030). Цифр о парке,
...
const BLOCKS = [
  ...
  },
  {
    ...
    accent: "ваш путь.",
    body: "Снегоходные маршруты по зимней тайге. Зимняя программа фуникулёра «Якша Skyview» в коридоре Якша—Маньпупунёр планируется на снегоходах YÖRAN — снегоход линейки носит имя «Йиркап», третья ступень, план 2030.",
    stat: { value: "Йиркап", label: "снегоход YÖRAN · III ступень · план 2030" },
  },
  {
    id: "03",
    frame: FRAME_BLOCK_3,
